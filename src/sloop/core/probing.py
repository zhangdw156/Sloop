...
class CapabilityProber:
    ...
    def __init__(self, config: SloopConfig):
        ...
        """
        self.config = config
        self.client = OpenAI(api_key=config.weak.api_key, base_url=config.weak.base_url)
    ...
    def run_probe(self, dataset_file: str, output_file: str) -> None:
        ...
        print(
            f"探测完成，共发现 {len(boundary_cases)} 个边界案例，已保存至 {output_file}"
        )
